...
// TODO: 改名tab1=> 页签名称
const endpoint =
  '/ec/services/projects/:orgId/generateTemplate/:projectCostId/tab1'

const iesPath = (orgId, activeItemId, id) =>
  `/projects/${orgId}/generateTemplate/${activeItemId}/tab1/${id ? '' : '/' + id}`

module.exports = [
  {
    description: '获取tab1列表接口',
    url: endpoint,
    method: 'get',
    req: {
      orgId: {
    ...
    res: {
      async mock () {
        const result = await mockData('/project/orgId/tab1')
        return result.data
      }
      // ,
  ...
  },
  {
    ...
    res: {
      ...
      //     path: iesPath(orgId,activeItemId,id),
      //     body: ctx.request.body
      //   })
      // }
    }
